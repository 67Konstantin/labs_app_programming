...
def is_divisible_by_three(binary_string: str) -> bool:
    ...
    if not re.fullmatch(pattern, binary_string):
        raise ValueError("Число не делится на 3")
...
if __name__ == "__main__":
    ...
    b = test_cases[-1]
    print(
        f"Число {b} в десятичной системе: {int(str(b), 2)} кратно 3: {is_divisible_by_three(str(b))}"
    )
    # a = 12000
